...
\begin{table}[H]
      ...
      \begin{tabular}{|l|l|l|l|l|l|}
            ...
            Organizar dados em um Data Set                              &                                    &                          & \cellcolor[HTML]{C0C0C0} &                          &                          \\ \hline
            Desenvolvimento do repositório acadêmico                    &                                    &                          & \cellcolor[HTML]{C0C0C0} & \cellcolor[HTML]{C0C0C0} &                          \\ \hline
            Documentação dos resultados                                 &                                    &                          &                          & \cellcolor[HTML]{C0C0C0} & \cellcolor[HTML]{C0C0C0} \\ \hline
            Entrega do Relatório Final                                  &                                    &                          &                          &                          & \cellcolor[HTML]{C0C0C0} \\ \hline
            Apresentação do Relatório Final em seminário                &                                    &                          &                          &                          & \cellcolor[HTML]{C0C0C0} \\ \hline
      \end{tabular}
\end{table}
