...
A delimitação do tema se dará como o desenvolvimento de um repositório institucional
de periódicos acadêmicos baseado em nuvem, tendo como objetivo reunir e preservar
...
Desenvolver um repositório institucional de trabalhos acadêmicos baseado
em nuvem, que envolva o processo de correções e envio de revisões
de publicações dentro da própria plataforma.
...
\begin{enumerate}
    \item O recurso de Full Text Search do banco de dados PostgreSQL
          ...
          (menos de 3 segundos por consulta).

    \item O processo desenvolvido para extração do texto das publicações
          para pesquisa e indexação é rápido o suficiente para não necessitar
          de processamento em segundo plano (menos de 5 segundos),
          mesmo em relatórios com mais de 200 páginas.
\end{enumerate}
