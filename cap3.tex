...
Para obter o tempo médio de consulta por publicações dentro do repositório
institucional desenvolvido, foi realizado a preparação de uma base de dados
com 3.500 publicações, tento como base o \emph{arXiv Dataset},
que consiste em um \emph{dataset} gratuito de publicações acadêmicas.
...
processo que uma publicação realizada por um usuário real, porem de forma automatizada.
