...
Conforme \cite{2017:Carvalho} O PostgreSQL é um sistema gerenciador de banco de dados
relacional de código aberto, sendo popular e com mais de 15 anos de desenvolvimento ativo,
possuindo uma arquitetura que entrega confiabilidade, integridade de dados e conformidade
a padrões. Dentre os principais características, está a facilidade de usar, a segurança,
grande quantidade de recursos, a confiabilidade e o desempenho.

Dentre os seus recursos está o suporte a vários tipos de dados sofisticados,
como o JSON, XML, objetos geométricos, hierarquias, tags e matrizes. Além de
permitir novos tipos de dados e funções que podem ser escritos em linguagens suportadas
como o SQL, C, Python, Peal, TCL e outras. O banco de dados também possui suporte
a recursos de acompanhamento de \emph{slow query}, criptografia e \emph{full-text search},
sendo o ultimo utilizado para realizar as buscas por publicações dentro do repositório
institucional proposto neste trabalho.

\subsubsection{Full-Text Search}

Conforme a documentação oficial do Postgres\footnote{https://www.postgresql.org/docs/current/textsearch-intro.html}, o recurso de \emph{Full Text Searching}
prove a capacidade de identificar linguagem natural em documentos que satisfazem
um critério de busca, podendo de forma opcional ordena-los por relevância aos termos
pesquisados.
