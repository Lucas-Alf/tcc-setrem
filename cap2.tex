...
Aos poucos a Gestão de Conhecimento também vem abordando a ênfase sobre documentar
...
\begin{table}[H]
    ...
    \resizebox{1.0\textwidth}{!}{% 
        \begin{tabular}{|p{3cm}|p{14cm}|}
            ...
            \emph{Contributor}     & Entidade responsável por realizar contribuições ao conteúdo do recurso. \\ \hline
...
\begin{figure}[H]
    ...
    \source{Adaptado de \cite{uzayr:mockups}}
...
realização deste trabalho consiste no .NET 7.0, que possui um ecossistema
vasto para o desenvolvimento de aplicações \emph{web}, em nuvem, \emph{desktop}, \emph{IoT}
e \emph{mobile}.

O .NET 7.0 foi escolhido como plataforma para o desenvolvimento da API do
...
\begin{figure}[H]
    ...
    \centering
    \frame{\includegraphics[scale=0.85]{img/bundle-based.png}}
...
\begin{figure}[H]
    ...
    \source{Adaptado de \cite{2022:PostgreSQL}}
\end{figure}
...
Nos Quadros \ref{table:related-works-1} e \ref{table:related-works-2} é apresentado um resumo dos trabalhos relacionados citados
...
\begin{landscape}
    \begin{table}[H]
        ...
        \label{table:related-works-1}
        \centering
        \setlength\extrarowheight{-1pt}
        \resizebox{1.50\textwidth}{!}{% 
