...
\section{Gestão do Conhecimento}\label{sec:knowledge}
...
\section{Ferramentas utilizadas}\label{sec:frameworks}
...
\section{Sistemas Relacionados}\label{sec:related}
\subsection{DSpace}
    ...
    \begin{table}[H]
        ...
        \resizebox{1.6\textwidth}{!}{%
            \begin{tabular}{|l|l|l|l|l|l|}
                \hline
                \textbf{Trabalho}                    & \textbf{Objetivo}          & \textbf{Metodologia}                & \textbf{Resultados}        & \textbf{Conclusão}         & \textbf{Ano} \\ \hline
                \cite{PereiraClaytonMartins2021Cfpd} & \begin{tabular}[c]{@{}l@{}}Apresenta uma proposta de categorias fundamentais\\ a serem utilizadas para a construção de uma interface\\ de navegação facetada para uma biblioteca digital\\ de teses e dissertações.\end{tabular}  & Qualitativa e exploratória.         & \begin{tabular}[c]{@{}l@{}}Foram criadas 8 categorias fundamentais\\ para a navegação facetada.\end{tabular}  & \begin{tabular}[c]{@{}l@{}}As categorias fundamentais propostas neste trabalho\\ podem contribuir significativamente para a construção\\ de um mecanismo de busca facetada.\end{tabular}  & 2021         \\ \hline
                \cite{QueirozArca:2020}              & \begin{tabular}[c]{@{}l@{}}Construção do Plano de Ação de Preservação Digital\\ para o Arca – Repositório Institucional da Fiocruz\end{tabular}  & Qualitativa e descritiva            & \begin{tabular}[c]{@{}l@{}}O Plano de Ação de Preservação Digital do\\ repositório Arca estabelece os padrões que\\ visam garantir que a produção cientifica seja\\ preservada de forma permanente, em um\\ ambiente confiável e seguro.\end{tabular}  & \begin{tabular}[c]{@{}l@{}}Algumas das recomendações resultantes dos\\ diagnósticos não estão diretamente relacionadas ao\\ Plano de Ação de Preservação Digital, mas podem\\ ser incorporadas ao Plano Operativo do repositório Arca.\end{tabular}  & 2020         \\ \hline
                \cite{GarciaRodrigoMoreira2019DdnB}  & \begin{tabular}[c]{@{}l@{}}Desenvolvimento da na nova plataforma de Biblioteca\\ Digital da BBM (Biblioteca Brasiliana Guita e José Mindlin)\end{tabular}  & Descritiva e relato de experiência. & \begin{tabular}[c]{@{}l@{}}Foi optado por realizar uma customização\\ do sistema DSpace, um \emph{software open source}\\ de repositório digital.\end{tabular}  & \begin{tabular}[c]{@{}l@{}}Como principais problemas e êxitos, foi ressaltado\\ que a forma como as customizações foram realizadas\\ no DSpace tornam difícil para novas versões da plataforma\end{tabular}  & 2019         \\ \hline
                \cite{Weitzel:2019}                  & \begin{tabular}[c]{@{}l@{}}Mapear os repositórios institucionais brasileiros\\ até o período de maio de 2017 a fim de retratar a situação\\ atual e contribuir com subsídios para orientar\\ as ações e diretrizes para implementação de repositórios.\end{tabular} & \begin{tabular}[c]{@{}l@{}}Levantamento exaustivo de repositórios\\ brasileiros por meio de fontes específicas\\ e pela observação direta. \end{tabular}          & \begin{tabular}[c]{@{}l@{}}Foi verificado que cerca de 54,5\% dos repositórios\\ concentram 97,5\% do total de artigos dentre\\ os 101 repositórios identificados no país. \end{tabular} & \begin{tabular}[c]{@{}l@{}}O estudo recomenda que o governo brasileiro\\ estabeleça diretrizes nacionais para fomentar as boas\\ práticas em repositórios no país com o objetivo de\\ fortalecer o desenvolvimento do Acesso Aberto Verde\end{tabular} & 2019         \\ \hline
                \cite{FernandesMacedes:2019}         & \begin{tabular}[c]{@{}l@{}}Compreender de que forma ocorre a encontrabilidade\\ da informação em repositórios institucionais a partir do\\ uso de dispositivos móveis, com ênfase no Repositório\\ Institucional UNESP\end{tabular} & Método quadripolar.                 & \begin{tabular}[c]{@{}l@{}}No repositório analisado elementos não relevantes\\ em dispositivos moveis possuem maior destaque\\ do que outros elementos que possuem maior importância. \end{tabular} & \begin{tabular}[c]{@{}l@{}}O Repositório Institucional UNESP já possui algum nível\\ de preocupação com a responsividade para dispositivos\\ moveis em seu \emph{website}, entretanto com a pesquisa realizada\\ foram encontrados alguns pontos que podem ser aprimorados.\end{tabular} & 2018         \\ \hline
                \cite{CERVI:bdtc}                    & \begin{tabular}[c]{@{}l@{}}Apresentação da proposta de biblioteca digital de\\ trabalhos científicos, que foi denominada como BDTC.\end{tabular} & Qualitativa                         & \begin{tabular}[c]{@{}l@{}}Apresentação uma biblioteca digital de trabalhos\\ científicos, a BDTC, que faz uso de serviços como\\ autoarquivamento de conteúdo, extração de metadados\\ dos objetos digitais e busca por similaridade.\end{tabular} & \begin{tabular}[c]{@{}l@{}}Com relação ao processo de extração automática\\ dos metadados dos objetos digitais, a ocorrência\\ de erros é minimizada, ficando a critério do autor\\ realizar apenas a confirmação dos metadados extraídos.\end{tabular} & 2009         \\ \hline
            \end{tabular}%
        }
    \end{table}
\end{landscape}