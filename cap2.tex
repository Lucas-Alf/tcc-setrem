...
de forma a entregar aos \emph{stakeholders} uma experiencia de usuário (UX)
...
como uma simulação do \emph{website} final, permitindo a experiencia de
...
o acesso em rede de forma onipresente, convivente e sob-demanda
...
\begin{enumerate}
    ...
    \item \emph{Hybrid cloud}: a infraestrutura de nuvem é composta por dois ou mais
          ...
          sendo unificados por uma tecnologia aberta ou proprietária que permite a
