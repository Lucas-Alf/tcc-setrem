...
No Quadro 3 é apresentado um resumo dos trabalhos relacionados citados
nesta pesquisa, contendo o titulo, objetivo, metodologia, resultados,
e conclusões de cada trabalho.
    ...
    \begin{table}[H]
        ...
        \resizebox{1.58\textwidth}{!}{% 
            \begin{tabular}{|p{5cm}|p{12cm}|p{12cm}|p{4cm}|p{13cm}|}
                \hline
                \textbf{Trabalho}            & \textbf{Titulo}                                                                                                                           & \textbf{Objetivo}                                                                                                                                           & \textbf{Metodologia}                & \textbf{Resultados}                                                                                                                                                                          \\ \hline
